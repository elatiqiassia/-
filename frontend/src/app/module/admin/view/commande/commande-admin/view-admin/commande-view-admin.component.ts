...
export class CommandeViewAdminComponent extends AbstractViewController<CommandeDto, CommandeCriteria, CommandeService> implements OnInit {
    ...
    constructor(private commandeService: CommandeService, private commandeItemService: CommandeItemService, private produitService: ProduitService, private clientService: ClientService, private etatCommandeService: EtatCommandeService){
