...
export class PaiementAchatEditAdminComponent extends AbstractEditController<PaiementAchatDto, PaiementAchatCriteria, PaiementAchatService>   implements OnInit {
    ...
    constructor( private paiementAchatService: PaiementAchatService , private achatService: AchatService, private modePaiementService: ModePaiementService, private etatPaiementAchatService: EtatPaiementAchatService) {
