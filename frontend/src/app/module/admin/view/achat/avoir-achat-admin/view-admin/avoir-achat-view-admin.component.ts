...
export class AvoirAchatViewAdminComponent extends AbstractViewController<AvoirAchatDto, AvoirAchatCriteria, AvoirAchatService> implements OnInit {
    ...
    constructor(private avoirAchatService: AvoirAchatService, private avoirAchatItemService: AvoirAchatItemService, private etatAvoirAchatService: EtatAvoirAchatService, private achatService: AchatService, private produitService: ProduitService){
