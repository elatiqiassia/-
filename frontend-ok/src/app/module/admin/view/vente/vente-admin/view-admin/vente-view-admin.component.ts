...
export class VenteViewAdminComponent extends AbstractViewController<VenteDto, VenteCriteria, VenteService> implements OnInit {
    ...
    constructor(private venteService: VenteService, private venteItemService: VenteItemService, private storeService: StoreService, private produitService: ProduitService, private clientService: ClientService, private etatVenteService: EtatVenteService){
        super(venteService);
    }
