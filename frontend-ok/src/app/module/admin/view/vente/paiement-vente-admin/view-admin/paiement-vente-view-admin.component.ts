...
export class PaiementVenteViewAdminComponent extends AbstractViewController<PaiementVenteDto, PaiementVenteCriteria, PaiementVenteService> implements OnInit {
    ...
    constructor(private paiementVenteService: PaiementVenteService, private venteService: VenteService, private etatPaiementVenteService: EtatPaiementVenteService, private modePaiementService: ModePaiementService){
