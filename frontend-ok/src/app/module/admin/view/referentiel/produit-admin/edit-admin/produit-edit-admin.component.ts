...
export class ProduitEditAdminComponent extends AbstractEditController<ProduitDto, ProduitCriteria, ProduitService>   implements OnInit {
    ...
    constructor( private produitService: ProduitService , private marqueService: MarqueService, private categorieProduitService: CategorieProduitService, private storeService: StoreService, private uniteMesureService: UniteMesureService) {
