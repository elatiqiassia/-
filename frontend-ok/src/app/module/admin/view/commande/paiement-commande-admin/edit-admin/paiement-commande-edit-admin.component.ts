...
export class PaiementCommandeEditAdminComponent extends AbstractEditController<PaiementCommandeDto, PaiementCommandeCriteria, PaiementCommandeService>   implements OnInit {
    ...
    constructor( private paiementCommandeService: PaiementCommandeService , private etatPaiementCommandeService: EtatPaiementCommandeService, private commandeService: CommandeService, private modePaiementService: ModePaiementService) {
