...
export class PaiementDemandeEditAdminComponent extends AbstractEditController<PaiementDemandeDto, PaiementDemandeCriteria, PaiementDemandeService>   implements OnInit {
    ...
    constructor( private paiementDemandeService: PaiementDemandeService , private etatPaiementDemandeService: EtatPaiementDemandeService, private demandeService: DemandeService, private modePaiementService: ModePaiementService) {
