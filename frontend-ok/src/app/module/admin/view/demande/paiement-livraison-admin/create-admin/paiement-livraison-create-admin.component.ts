...
export class PaiementLivraisonCreateAdminComponent extends AbstractCreateController<PaiementLivraisonDto, PaiementLivraisonCriteria, PaiementLivraisonService>  implements OnInit {
   ...
   private _validPaiementLivraisonReference = true;
    ...
    constructor( private paiementLivraisonService: PaiementLivraisonService , private livraisonService: LivraisonService, private venteService: VenteService, private modePaiementService: ModePaiementService, private etatPaiementLivraisonService: EtatPaiementLivraisonService) {
